...
function updateTimer() {
  const targetDate = new Date("March 1, 2025 21:15:00").getTime();
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  const phoneNumber1 = '543875103517'; // Número para el primer botón
...
document.addEventListener('DOMContentLoaded', function() {
  // Definir los números de teléfono
  const recipientNumber1 = '543875103517'; // Número para el primer botón
  const recipientNumber2 = '541123893491'; // Número para el segundo botón
